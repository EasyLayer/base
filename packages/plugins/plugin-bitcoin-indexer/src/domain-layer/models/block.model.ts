...
import { BitcoinBlockIndexedEvent, BitcoinBlockIndexCompletedEvent } from '@easylayer/domain-cqrs-components/bitcoin';
...
export class Block extends AggregateRoot {
  ...
  // set aggregateId(aggregateId: bigint | string) {
  //   this._aggregateId = String(aggregateId);
  // }
