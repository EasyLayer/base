...
import {
  ...
  BitcoinBalancesIndexerChainBlockAddedEvent,
  BitcoinBalancesIndexerReorganisationEvent,
  BitcoinBalancesIndexerIndexBlockConfirmedEvent,
  BitcoinBalancesIndexerChainBlockWithConfirmAddedEvent,
...
export class BalancesIndexer extends AggregateRoot {
  ...
  public async addBlock({ block, requestId }: { block: any; requestId: string }) {
    ...
    await this.apply(
      new BitcoinBalancesIndexerChainBlockAddedEvent({
        aggregateId: this.aggregateId,
        requestId,
  ...
  public async addBlockWithImmediatelyConfirm({ block, requestId }: { block: any; requestId: string }) {
    ...
    await this.apply(
      new BitcoinBalancesIndexerChainBlockWithConfirmAddedEvent({
        aggregateId: this.aggregateId,
        requestId,
  ...
  public async reorganisation({
    ...
    if (oldBlock.hash === localBlockNode.block.hash && oldBlock.previousblockhash === localBlockNode.block.prevHash) {
      // Match found
      await this.apply(
        new BitcoinBalancesIndexerReorganisationEvent({
          aggregateId: this.aggregateId,
          requestId,
  ...
  public async confirmIndexBlock({ block, requestId }: { block: any; requestId: string }) {
    ...
    await this.apply(
      new BitcoinBalancesIndexerIndexBlockConfirmedEvent({
        aggregateId: this.aggregateId,
        requestId,
        status: IndexerStatuses.AWAITING,
        block,
  ...
  private onBitcoinBalancesIndexerChainBlockAddedEvent({ payload }: BitcoinBalancesIndexerChainBlockAddedEvent) {
  ...
  private onBitcoinBalancesIndexerReorganisationEvent({ payload }: BitcoinBalancesIndexerReorganisationEvent) {
    const { height } = payload;
    this.chain.truncateToBlock(BigInt(height));
  }

  private onBitcoinBalancesIndexerIndexBlockConfirmedEvent({
    payload,
  }: BitcoinBalancesIndexerIndexBlockConfirmedEvent) {
  ...
  private onBitcoinBalancesIndexerChainBlockWithConfirmAddedEvent({
    payload,
  }: BitcoinBalancesIndexerChainBlockWithConfirmAddedEvent) {
    const { block, status } = payload;
