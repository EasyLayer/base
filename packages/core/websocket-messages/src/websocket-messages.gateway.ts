...
import { BasicMessage } from '@easylayer/components/domain-cqrs-components';
import { WebsocketMessage } from '@easylayer/components/domain-cqrs-components/websocket-messages';
import { EventBus, CustomEventBus } from '@easylayer/core/cqrs';
